...
public class ExchangeToken {
	...
	public String getApiToken(Model model, HttpServletRequest request) throws JsonMappingException, JsonProcessingException {
		...
		System.out.println("Demande de page d'échange de token");		
		...
		model.addAttribute("token",extoken);
		Triplet<String, String, String> tmp = Helper.splitAndDecodeToken(extoken);	
