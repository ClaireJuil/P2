 ...
 * 
 */
	public static String extractExchangedToken(String jsonTokenExchangeResponse) throws JsonMappingException, JsonProcessingException {
		/*
		 * 
		 * {
		 * "access_token":
		...
		//EchangeTokenResponse response = mapper.readValue(jsonTokenExchangeResponse, EchangeTokenResponse.class);
		//return response.getAccesstoken();
		return(nameNode.get(EX_ACCESS_TOKEN).asText());
	}

/*
 * Décodage et découpage d'un aceesToken
 */
	public static Triplet<String, String, String> splitAndDecodeTokenFromResponse (String jsonTokenExchangeResponse) throws JsonMappingException, JsonProcessingException  {
		       
		String accessTokenBase64 = extractExchangedToken(jsonTokenExchangeResponse);
		String[] chunks = accessTokenBase64.split("\\.");
	...
	public static Token extractTokenObjectFromDecodedSplitedToken(Triplet<String, String, String> splitedDecodedToken) throws JsonMappingException, JsonProcessingException  {
		ObjectMapper mapper = new ObjectMapper();
